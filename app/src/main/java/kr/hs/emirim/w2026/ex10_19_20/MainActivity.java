package kr.hs.emirim.w2026.ex10_19_20;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnSaerch = findViewById(R.id.btn_search);
        ...
        btnSaerch.setOnClickListener(btnListener);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                ...
                case R.id.btn_homepage:
                    ...
                    break;
                case R.id.btn_map:
                    uri = Uri.parse("https://maps.google.co.kr/maps?q="+37.4667575476549+","+126.9328436250530+"&z=15");
                    intent = new Intent(Intent.ACTION_VIEW, uri);
                    break;
